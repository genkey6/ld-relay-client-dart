...
void testArray() {
  ...
  test('getType', () {
    ...
    expect(LDValue.buildArray().addBool(true).build().getType(),
        equals(LDValueType.ARRAY));
  });
  ...
  test('values', () {
    LDValue testArray = LDValue.buildArray()
        .addString('abc')
  ...
  test('builder normalize', () {
    LDValue normalizedArray = LDValue.buildArray()
        .addBool(null)
        .addNum(null)
        .addString(null)
        .addValue(null)
  ...
  test('builder reuse', () {
    ...
    expect(
        builtSecond, equals(LDValue.buildArray().addNum(1).addNum(2).build()));
...
void testObject() {
  test('size', () {
    ...
    expect(LDValue.buildObject().addNum('a', 3).addNum('b', 2).build().size(),
        equals(2));
  });

  test('getType', () {
    expect(LDValue.buildObject().build().getType(), equals(LDValueType.OBJECT));
    expect(LDValue.buildObject().addBool('k', true).build().getType(),
        equals(LDValueType.OBJECT));
  });

  test('getFor', () {
    LDValue testObject =
        LDValue.buildObject().addNum('k1', 1).addBool('k2', false).build();
    expect(testObject.getFor('k1'), equals(LDValue.ofNum(1)));
    expect(testObject.getFor('k2'), equals(LDValue.ofBool(false)));
  });

  test('keys', () {
    LDValue testObject = LDValue.buildObject()
        .addString('a', 'def')
        .addValue('b', LDValue.ofNull())
        .build();
  ...
  test('values', () {
    LDValue testObject = LDValue.buildObject()
        .addString('c', 'abc')
        .addValue('d', LDValue.ofNull())
        .build();
    expect(testObject.values(),
        containsAll([LDValue.ofString('abc'), LDValue.ofNull()]));
  ...
  test('builder reuse', () {
    ...
    expect(builtSecond,
        equals(LDValue.buildObject().addNum('k1', 1).addNum('k2', 2).build()));
    expect(builtSecond, isNot(same(builder.build())));
  });
}
...
void testFromCodec() {
  ...
  test('primitive arrays', () {
    ...
    expect(LDValue.fromCodecValue([null]),
        equals(LDValue.buildArray().addValue(LDValue.ofNull()).build()));
    expect(LDValue.fromCodecValue([false, true]),
        equals(LDValue.buildArray().addBool(false).addBool(true).build()));
    expect(LDValue.fromCodecValue([1, 2]),
        equals(LDValue.buildArray().addNum(1).addNum(2).build()));
    expect(LDValue.fromCodecValue(['abc', 'def']),
        equals(LDValue.buildArray().addString('abc').addString('def').build()));
    expect(
        LDValue.fromCodecValue([null, true, 3.0, 'c']),
        equals(LDValue.buildArray()
            .addValue(LDValue.ofNull())
            .addBool(true)
            .addNum(3.0)
            .addString('c')
    ...
    expect(LDValue.fromCodecValue([DateTime.now()]),
        equals(LDValue.buildArray().addValue(LDValue.ofNull()).build()));
  });
  ...
  test('primitive objects', () {
    ...
    expect(LDValue.fromCodecValue({'n': null}),
        equals(LDValue.buildObject().addValue('n', LDValue.ofNull()).build()));
    expect(
        LDValue.fromCodecValue({'true': true, 'false': false}),
        equals(LDValue.buildObject()
            .addBool('true', true)
            .addBool('false', false)
            .build()));
    ...
    expect(
        LDValue.fromCodecValue({'': 'abc', 'def': 'bar'}),
        equals(LDValue.buildObject()
            .addString('', 'abc')
            .addString('def', 'bar')
            .build()));
    ...
    expect(LDValue.fromCodecValue({'k': DateTime.now()}),
        equals(LDValue.buildObject().addValue('k', LDValue.ofNull()).build()));
  });
